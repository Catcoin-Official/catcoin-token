...
contract TestCat is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    string private constant _name = "CatTest";
    string private constant _symbol = "TestCat";
    ...
    address payable public _devwallet = payable(address(0x4081c2e9338Aab51480acBb34f6664e32509b9F7));
